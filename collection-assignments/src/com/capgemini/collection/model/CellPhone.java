...
public class CellPhone {
	...
	public boolean equals(Object obj) {
		...
		if (this == obj)
			return true;
		CellPhone mobile = (CellPhone) obj;
		if (this.company == mobile.company && this.model == mobile.model && this.description == mobile.description
				&& this.operatingSystem == mobile.operatingSystem && this.price == mobile.price)
			return true;
		return false;
	}
